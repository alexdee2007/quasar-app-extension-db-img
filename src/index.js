...
function extendConf(conf) {
  ...
  conf.boot.push('~quasar-app-extension-db-img/src/boot/register-db-img.js')

  // make sure boot & component files get transpiled
  conf.build.transpileDependencies.push(/quasar-app-extension-db-img[\\/]src/)

  // make sure my-ext css goes through webpack to avoid ssr issues
  conf.css.push('~quasar-app-extension-db-img/src/component/DbImg.styl')
}
